...
public class TimerWorker extends Worker {
    ...
    public Result doWork() {
        ...
        if(App.getInstance().isFasting()){
            ...
            notification = notifier.createFastingNotification();
            notificationCode = MyNotify.FASTING_NOTIFICATION;

        }
        else{
            notifier.cancelFastingNotification();
            notification = notifier.createEatingNotification();
            notificationCode = MyNotify.EATING_NOTIFICATION;
        }
